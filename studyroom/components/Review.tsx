...
import { View, Text, StyleSheet, ActivityIndicator, TextInput, KeyboardAvoidingView, TouchableOpacity } from 'react-native';
...
const StarRat: React.FC<StarRatingProps> = ({ initialRating = 0, onRatingChange }) => {
    ...
    useEffect(() => {
        const fetchReviews = async () => {
            ...
            try {
                ...
                const response = await axios.post(`${BACKEND}/api/v1/library/getReviews/${libraryId}`);
    ...
    const createReview = async () => {
       ...
       const u = JSON.parse(user)
        ...
        try {
            ...
            const response = await axios.post(`${BACKEND}/api/v1/library/createReview/${libraryId}`, {
