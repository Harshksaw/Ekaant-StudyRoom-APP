...
// // Add a prop type definition for clarity and type safety
// interface PhotosUploaderProps {
//   onChange: (updateFn: (prev: string[]) => string[]) => void;
// }

// export default function PhotosUploader({ onChange }: PhotosUploaderProps) {
//   const [photoLink, setPhotoLink] = useState("");
//   async function addPhotoByLink(e) {
//     e.preventDefault();
//     const { data: filename } = await axios.post("/api/upload", {
//       link: photoLink,
//     });
//     onChange((prev) => {
