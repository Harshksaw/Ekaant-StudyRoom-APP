...
SELECT pg_catalog.setval('public."Booking_id_seq"', 242, true);
...
SELECT pg_catalog.setval('public."PhoneOtp_id_seq"', 431, true);
...
SELECT pg_catalog.setval('public."Transaction_id_seq"', 295, true);
